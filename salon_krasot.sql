...
(2, 'Манекюр', 600.00, 'Уход за пальцами рук, чистка, полировка, покрытие лаком ногтей.', '2.png'),
(3, 'Педикюр', 400.00, 'Уход за ступнями и пальцами ног (чистка и полировка ногтей, удаление мозолей и т. п.).', '3а.png'),
(4, 'Окрашивание волос', 1100.00, 'Процесс, в ходе которого наносится специальное красящее вещество, способное изменить природный цвет или оттенок.', '5а.png'),
(5, 'Стрижка огнём', 1500.00, 'Cпособ ухода за волосами, заключающийся в воздействии открытого огня на стержень волоса.', '6.png'),
(6, 'Стрижка волос', 300.00, 'Укорачивание волос. Процесс стрижки состоит из методов, операций, срезов, определенного фасона.', '7а.png'),
